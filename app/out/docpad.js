  ...
  docpadConfig = {
    ...
    events: {
      ...
      serverExtend: function(opts) {
        var codeBadRequest, codeRedirectPermanent, codeRedirectTemporary, codeSuccess, docpad, express, redirects, request, server, src, target;
        ...
        for (src in redirects) {
          if (!__hasProp.call(redirects, src)) continue;
          target = redirects[src];
          server.get(src, function(req, res) {
